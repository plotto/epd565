...
expectedColorByteArray = bytearray(([byte for colorBytes in [eInkTruePaletteBytes[color] for color in activeColors] for byte in colorBytes] * ceil(1024.0/(len(activeColors)*4)))[:1024])
